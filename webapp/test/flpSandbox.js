		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Taller Final",
									"targetURL": "#tallerfinaltallerfinal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tallerfinaltallerfinal-display": {
								"semanticObject": "tallerfinaltallerfinal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tallerfinal.tallerfinal",
									"url": sap.ui.require.toUrl("tallerfinal/tallerfinal")
								}
							}
						}
					}
